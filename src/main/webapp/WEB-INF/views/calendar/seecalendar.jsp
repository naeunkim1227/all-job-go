...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/calendar_set.css">
<link
	href='${pageContext.request.contextPath}/resources/css/calendar.css'
	rel='stylesheet' />
<script
	src='${pageContext.request.contextPath}/resources/js/calendar/calendar.js'></script>
<script
	src='${pageContext.request.contextPath}/resources/js/calendar/jquery-3.6.0.min.js'></script>
<script
	src='${pageContext.request.contextPath}/resources/js/jquery-3.6.0.js'></script>
<script
	src='${pageContext.request.contextPath}/resources/js/calendar/ko.js'></script>
			...
			<div id="table">
				...
				<c:choose>
					<c:when test="${fn:length(classlist) eq 0}">
						<tr><td><h3>나의 관심 클래스가 없습니다. 추가해보세요!</h3></td></tr>
					</c:when>
					<c:otherwise>
							<tr id="title1">
								<td>나의 관심 클래스</td>
				...
				<c:choose>
					<c:when test="${fn:length(academylist) eq 0}">
						<tr><td><h3>나의 관심 학원이 없습니다. 추가해보세요!</h3></td></tr>
					</c:when>
					<c:otherwise>
							<tr id="title1">
								<td>나의 관심 학원 커리큘럼</td>
